<?php include_once 'php_action/conexao_bd.php';
				...
				<?php 
					...
					?>				
						...
						<tr>
							...
							<td><?php echo $dados['obsPet']; ?></td>
							<td><?php echo $dados['nomeTutor']; ?></td>
							<td><?php echo $dados['emailTutor']; ?></td>
							<td><?php echo $dados['telCelular']; ?></td>
